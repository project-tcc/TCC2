<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadFuncionario.aspx.cs" Inherits="Desenvolvimento2.CadFuncionario" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <body>
         ...
         <label for="name">CADASTRO DE FUNCIONÁRIOS</label>
        <br />
    <form id="form1" runat="server" class="auto-style2">
        ...
        <asp:Label ID="lbl_telefone_emergencial" runat="server" Text="Telefone Emergencial"></asp:Label>
        <br />
        ...
        <asp:Label ID="lbl_CEP" runat="server" Text="CEP"></asp:Label>
                ...
                <asp:TextBox ID="txt_tipo_logradouro" runat="server" class="form-control"></asp:TextBox>&nbsp;<asp:Label ID="lbl_rua" runat="server" Text="Nome da Rua"></asp:Label>
